...
class cusers extends cTable {
	...
	function __construct() {
		...
		// group
		$this->group = new cField('users', 'users', 'x_group', 'group', '`group`', '`group`', 3, -1, FALSE, '`group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mobile
		$this->mobile = new cField('users', 'users', 'x_mobile', 'mobile', '`mobile`', '`mobile`', 200, -1, FALSE, '`mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
