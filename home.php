...
<div class="panel panel-danger">
	 ...
	 <marquee width="70%" direction="left" height="20px">
		<strong><span style="color:#8d1c2d !important">WELCOME TO GROOMING CENTRE INCIDENT-REPORTING-PLATFORM:    All Issue Reported Here Are Being Treated Realtime:  Ensure To Login At Interval To Report and Resolved Any Issue Encountered:        Signed Management!  <?php echo $_SESSION['Staff_Name']?> </span></strong> 
...
<div class="col-md-3 col-sm-6 col-xs-12">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box bg-red-gradient">
				...
				<div class="info-box-content">
					<span class="info-box-text">Issue Pending<p>With Automation</span>
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box bg-green-gradient">
				...
				<div class="info-box-content">
					<span class="info-box-text">Issue Closed<p>By Automation</span>
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			...
			<span class="info-box-icon"><i class="fa fa-ban" aria-hidden="true"></i></span>				
			<div class="info-box-content">
					<span class="info-box-text">Issue UnderReview<p>with Mquid</span>
					<span class="info-box-number"><?php echo $_SESSION['MyReviewCount'] ?></span>
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box bg-purple-gradient">
				<span class="info-box-icon"><i class="fa fa-thumbs-up" aria-hidden="true"></i></span>
				<div class="info-box-content">
					<span class="info-box-text">Issued Resolved<p>By Mquid</span>
					<span class="info-box-number"><?php echo $_SESSION['MyResolutionCount'] ?></span>
