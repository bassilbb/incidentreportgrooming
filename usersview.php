...
fusersview.Lists["x_group"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_group_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"group"};
fusersview.Lists["x_group"].Data = "<?php echo $users_view->group->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($users->group->Visible) { // group ?>
	<tr id="r_group">
		<td class="col-sm-2"><span id="elh_users_group"><?php echo $users->group->FldCaption() ?></span></td>
		<td data-name="group"<?php echo $users->group->CellAttributes() ?>>
<span id="el_users_group">
<span<?php echo $users->group->ViewAttributes() ?>>
<?php echo $users->group->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
