...
<?php if (!isset($userlevelpermissions_view->Pager)) $userlevelpermissions_view->Pager = new cPrevNextPager($userlevelpermissions_view->StartRec, $userlevelpermissions_view->DisplayRecs, $userlevelpermissions_view->TotalRecs, $userlevelpermissions_view->AutoHidePager) ?>
