...
fuserslist.Lists["x_group"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_group_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"group"};
fuserslist.Lists["x_group"].Data = "<?php echo $users_list->group->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($users->group->Visible) { // group ?>
	<?php if ($users->SortUrl($users->group) == "") { ?>
		<th data-name="group" class="<?php echo $users->group->HeaderCellClass() ?>"><div id="elh_users_group" class="users_group"><div class="ewTableHeaderCaption"><?php echo $users->group->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="group" class="<?php echo $users->group->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->group) ?>',1);"><div id="elh_users_group" class="users_group">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->group->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->group->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->group->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($users->staff_id->Visible) { // staff_id ?>
	<?php if ($users->SortUrl($users->staff_id) == "") { ?>
		<th data-name="staff_id" class="<?php echo $users->staff_id->HeaderCellClass() ?>"><div id="elh_users_staff_id" class="users_staff_id"><div class="ewTableHeaderCaption"><?php echo $users->staff_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="staff_id" class="<?php echo $users->staff_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->staff_id) ?>',1);"><div id="elh_users_staff_id" class="users_staff_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->staff_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->staff_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->staff_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<?php echo $users->department->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($users->group->Visible) { // group ?>
		<td data-name="group"<?php echo $users->group->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_group" class="users_group">
<span<?php echo $users->group->ViewAttributes() ?>>
<?php echo $users->group->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($users->gender->Visible) { // gender ?>
...
<span id="el<?php echo $users_list->RowCnt ?>_users_staff_id" class="users_staff_id">
<span<?php echo $users->staff_id->ViewAttributes() ?>>
<?php echo $users->staff_id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
