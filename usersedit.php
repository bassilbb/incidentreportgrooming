...
fusersedit.Lists["x_group"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_group_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"group"};
fusersedit.Lists["x_group"].Data = "<?php echo $users_edit->group->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($users->group->Visible) { // group ?>
	<div id="r_group" class="form-group">
		<label id="elh_users_group" for="x_group" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->group->FldCaption() ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->group->CellAttributes() ?>>
