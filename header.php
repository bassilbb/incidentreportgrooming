...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>alertifyjs/alertify.min.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $EW_RELATIVE_PATH ?>alertifyjs/css/alertify.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo $EW_RELATIVE_PATH ?>alertifyjs/css/themes/default.min.css">
...
<div class="wrapper ewLayout">
	...
	<header class="main-header">
		<div class="logo">
			...
			<span class="logo-lg">INCIDENT REPORT SYSTEM</span>
		</div>
		<!-- Header Navbar -->
