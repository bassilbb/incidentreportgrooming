...
freport_formdelete.Lists["x_departments"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_category"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departments"};
freport_formdelete.Lists["x_departments"].Data = "<?php echo $report_form_delete->departments->LookupFilterQuery(FALSE, "delete") ?>";
...
freport_formdelete.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_category"};
...
freport_formdelete.Lists["x_operational_status"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"operational_status"};
freport_formdelete.Lists["x_operational_status"].Data = "<?php echo $report_form_delete->operational_status->LookupFilterQuery(FALSE, "delete") ?>";
freport_formdelete.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
<?php if ($report_form->departments->Visible) { // departments ?>
		<th class="<?php echo $report_form->departments->HeaderCellClass() ?>"><span id="elh_report_form_departments" class="report_form_departments"><?php echo $report_form->departments->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($report_form->operational_status->Visible) { // operational_status ?>
		<th class="<?php echo $report_form->operational_status->HeaderCellClass() ?>"><span id="elh_report_form_operational_status" class="report_form_operational_status"><?php echo $report_form->operational_status->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($report_form->departments->Visible) { // departments ?>
		<td<?php echo $report_form->departments->CellAttributes() ?>>
<span id="el<?php echo $report_form_delete->RowCnt ?>_report_form_departments" class="report_form_departments">
...
<?php } ?>
<?php if ($report_form->operational_status->Visible) { // operational_status ?>
		<td<?php echo $report_form->operational_status->CellAttributes() ?>>
<span id="el<?php echo $report_form_delete->RowCnt ?>_report_form_operational_status" class="report_form_operational_status">
