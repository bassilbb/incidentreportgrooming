...
class creport_history_list extends creport_history {
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'report_history', TRUE);
...
freport_historylist.Lists["x_departments"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_category"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departments"};
freport_historylist.Lists["x_departments"].Data = "<?php echo $report_history_list->departments->LookupFilterQuery(FALSE, "list") ?>";
...
freport_historylist.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_category"};
...
freport_historylist.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freport_historylist.Lists["x_last_updated_by"].Data = "<?php echo $report_history_list->last_updated_by->LookupFilterQuery(FALSE, "list") ?>";
freport_historylist.AutoSuggests["x_last_updated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_history_list->last_updated_by->LookupFilterQuery(TRUE, "list"))) ?>;
...
freport_historylistsrch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckShortEuroDate(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($report_history->datetime_initiated->FldErrMsg()) ?>");
...
<input type="text" data-table="report_history" data-field="x_datetime_initiated" data-format="14" name="x_datetime_initiated" id="x_datetime_initiated" size="18" placeholder="<?php echo ew_HtmlEncode($report_history->datetime_initiated->getPlaceHolder()) ?>" value="<?php echo $report_history->datetime_initiated->EditValue ?>"<?php echo $report_history->datetime_initiated->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freport_historylistsrch", "x_datetime_initiated", {"ignoreReadonly":true,"useCurrent":false,"format":14});
</script>
<?php } ?>
</span>
...
<input type="text" data-table="report_history" data-field="x_datetime_initiated" data-format="14" name="y_datetime_initiated" id="y_datetime_initiated" size="18" placeholder="<?php echo ew_HtmlEncode($report_history->datetime_initiated->getPlaceHolder()) ?>" value="<?php echo $report_history->datetime_initiated->EditValue2 ?>"<?php echo $report_history->datetime_initiated->EditAttributes() ?>>
<?php if (!$report_history->datetime_initiated->ReadOnly && !$report_history->datetime_initiated->Disabled && !isset($report_history->datetime_initiated->EditAttrs["readonly"]) && !isset($report_history->datetime_initiated->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("freport_historylistsrch", "y_datetime_initiated", {"ignoreReadonly":true,"useCurrent":false,"format":14});
</script>
<?php } ?>
</span>
	</div>
...
<span id="as_x_staff_id" style="white-space: nowrap; z-index: 8950">
	<input type="text" name="sv_x_staff_id" id="sv_x_staff_id" value="<?php echo $report_history->staff_id->EditValue ?>" size="18" placeholder="<?php echo ew_HtmlEncode($report_history->staff_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($report_history->staff_id->getPlaceHolder()) ?>"<?php echo $report_history->staff_id->EditAttributes() ?>>
</span>
...
<?php if ($report_history->departments->Visible) { // departments ?>
	<?php if ($report_history->SortUrl($report_history->departments) == "") { ?>
		<th data-name="departments" class="<?php echo $report_history->departments->HeaderCellClass() ?>"><div id="elh_report_history_departments" class="report_history_departments"><div class="ewTableHeaderCaption"><?php echo $report_history->departments->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="departments" class="<?php echo $report_history->departments->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_history->SortUrl($report_history->departments) ?>',1);"><div id="elh_report_history_departments" class="report_history_departments">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_history->departments->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_history->departments->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_history->departments->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($report_history->status->Visible) { // status ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($report_history->last_updated_date->Visible) { // last_updated_date ?>
	<?php if ($report_history->SortUrl($report_history->last_updated_date) == "") { ?>
		<th data-name="last_updated_date" class="<?php echo $report_history->last_updated_date->HeaderCellClass() ?>"><div id="elh_report_history_last_updated_date" class="report_history_last_updated_date"><div class="ewTableHeaderCaption"><?php echo $report_history->last_updated_date->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="last_updated_date" class="<?php echo $report_history->last_updated_date->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_history->SortUrl($report_history->last_updated_date) ?>',1);"><div id="elh_report_history_last_updated_date" class="report_history_last_updated_date">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_history->last_updated_date->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_history->last_updated_date->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_history->last_updated_date->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($report_history->last_updated_by->Visible) { // last_updated_by ?>
	<?php if ($report_history->SortUrl($report_history->last_updated_by) == "") { ?>
		<th data-name="last_updated_by" class="<?php echo $report_history->last_updated_by->HeaderCellClass() ?>"><div id="elh_report_history_last_updated_by" class="report_history_last_updated_by"><div class="ewTableHeaderCaption"><?php echo $report_history->last_updated_by->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="last_updated_by" class="<?php echo $report_history->last_updated_by->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_history->SortUrl($report_history->last_updated_by) ?>',1);"><div id="elh_report_history_last_updated_by" class="report_history_last_updated_by">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_history->last_updated_by->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_history->last_updated_by->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_history->last_updated_by->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $report_history_list->RowCnt ?>_report_history_departments" class="report_history_departments">
<span<?php echo $report_history->departments->ViewAttributes() ?>>
<?php echo $report_history->departments->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($report_history->category->Visible) { // category ?>
...
<?php echo $report_history->status->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($report_history->last_updated_date->Visible) { // last_updated_date ?>
		<td data-name="last_updated_date"<?php echo $report_history->last_updated_date->CellAttributes() ?>>
<span id="el<?php echo $report_history_list->RowCnt ?>_report_history_last_updated_date" class="report_history_last_updated_date">
<span<?php echo $report_history->last_updated_date->ViewAttributes() ?>>
<?php echo $report_history->last_updated_date->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($report_history->last_updated_by->Visible) { // last_updated_by ?>
		<td data-name="last_updated_by"<?php echo $report_history->last_updated_by->CellAttributes() ?>>
<span id="el<?php echo $report_history_list->RowCnt ?>_report_history_last_updated_by" class="report_history_last_updated_by">
<span<?php echo $report_history->last_updated_by->ViewAttributes() ?>>
<?php echo $report_history->last_updated_by->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
