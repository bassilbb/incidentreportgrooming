...
define("EW_RANDOM_KEY", 'sSHCN6HMrIniWIkP', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "incident_report", "qs" => "`", "qe" => "`");
