...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'group'))
			$this->Page_Terminate("grouplist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'history'))
			$this->Page_Terminate("historylist.php");
		if ($Security->AllowList(CurrentProjectID() . 'daily_issue'))
			$this->Page_Terminate("daily_issuelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'resolved_issue'))
			$this->Page_Terminate("resolved_issuelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'awaits_resolution'))
			$this->Page_Terminate("awaits_resolutionlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'operational_status'))
			$this->Page_Terminate("operational_statuslist.php");
