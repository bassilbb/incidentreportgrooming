...
class creport_form_add extends creport_form {
	...
	function LoadDefaultValues() {
		...
		$this->operational_status->CurrentValue = NULL;
		$this->operational_status->OldValue = $this->operational_status->CurrentValue;
		...
		$this->closure_action->CurrentValue = NULL;
		$this->closure_action->OldValue = $this->closure_action->CurrentValue;
		$this->closure_comment->CurrentValue = NULL;
		$this->closure_comment->OldValue = $this->closure_comment->CurrentValue;
	...
	function NewRow() {
		...
		$row['operational_status'] = $this->operational_status->CurrentValue;
		...
		$row['closure_action'] = $this->closure_action->CurrentValue;
		$row['closure_comment'] = $this->closure_comment->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// start_date
		$this->start_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->start_date->CurrentValue, 2), NULL, FALSE);

		// end_date
		$this->end_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->end_date->CurrentValue, 2), NULL, FALSE);
		...
		// operational_status
		$this->operational_status->SetDbValueDef($rsnew, $this->operational_status->CurrentValue, NULL, FALSE);
		...
		// datetime_resolved
		$this->datetime_resolved->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->datetime_resolved->CurrentValue, 11), ew_CurrentDate(), FALSE);
		...
		// closure_action
		$this->closure_action->SetDbValueDef($rsnew, $this->closure_action->CurrentValue, NULL, FALSE);

		// closure_comment
		$this->closure_comment->SetDbValueDef($rsnew, $this->closure_comment->CurrentValue, NULL, FALSE);

		// last_updated_date
		$this->last_updated_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->last_updated_date->CurrentValue, 17), NULL, FALSE);
...
freport_formadd.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":["x_category"],"ChildFields":[],"FilterFields":["x_category_id"],"Options":[],"Template":"","LinkTable":"sub_category"};
...
freport_formadd.Lists["x_incident_location"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
...
freport_formadd.Lists["x_operational_status"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"operational_status"};
freport_formadd.Lists["x_operational_status"].Data = "<?php echo $report_form_add->operational_status->LookupFilterQuery(FALSE, "add") ?>";
...
freport_formadd.Lists["x_closure_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freport_formadd.Lists["x_closure_action"].Options = <?php echo json_encode($report_form_add->closure_action->Options()) ?>;
freport_formadd.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
<?php if ($report_form->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_report_form_staff_id" for="x_staff_id" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freport_formadd", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":2});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freport_formadd", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":2});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($report_form->incident_location->Visible) { // incident_location ?>
	<div id="r_incident_location" class="form-group">
		<label id="elh_report_form_incident_location" for="x_incident_location" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->incident_location->FldCaption() ?></label>
...
<?php if ($report_form->incident_description->Visible) { // incident_description ?>
	<div id="r_incident_description" class="form-group">
		<label id="elh_report_form_incident_description" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->incident_description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
ew_CreateEditor("freport_formadd", "x_incident_description", 35, 4, <?php echo ($report_form->incident_description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
<?php } else { ?>
<span id="el_report_form_incident_description">
...
<?php if ($report_form->operational_status->Visible) { // operational_status ?>
	<div id="r_operational_status" class="form-group">
		<label id="elh_report_form_operational_status" for="x_operational_status" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->operational_status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_form_add->RightColumnClass ?>"><div<?php echo $report_form->operational_status->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->resolved_action->Visible) { // resolved_action ?>
	<div id="r_resolved_action" class="form-group">
		<label id="elh_report_form_resolved_action" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->resolved_action->FldCaption() ?></label>
...
<?php if ($report_form->approval_action->Visible) { // approval_action ?>
	<div id="r_approval_action" class="form-group">
		<label id="elh_report_form_approval_action" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->approval_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($report_form->approval_comment->Visible) { // approval_comment ?>
	<div id="r_approval_comment" class="form-group">
		<label id="elh_report_form_approval_comment" for="x_approval_comment" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->approval_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($report_form->closure_action->Visible) { // closure_action ?>
	<div id="r_closure_action" class="form-group">
		<label id="elh_report_form_closure_action" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->closure_action->FldCaption() ?></label>
		<div class="<?php echo $report_form_add->RightColumnClass ?>"><div<?php echo $report_form->closure_action->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->closure_comment->Visible) { // closure_comment ?>
	<div id="r_closure_comment" class="form-group">
		<label id="elh_report_form_closure_comment" for="x_closure_comment" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->closure_comment->FldCaption() ?></label>
		<div class="<?php echo $report_form_add->RightColumnClass ?>"><div<?php echo $report_form->closure_comment->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->last_updated_date->Visible) { // last_updated_date ?>
	<div id="r_last_updated_date" class="form-group">
		<label id="elh_report_form_last_updated_date" for="x_last_updated_date" class="<?php echo $report_form_add->LeftColumnClass ?>"><?php echo $report_form->last_updated_date->FldCaption() ?></label>
