...
freport_historyview.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_category"};
...
freport_historyview.Lists["x_incident_location"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
...
freport_historyview.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freport_historyview.Lists["x_last_updated_by"].Data = "<?php echo $report_history_view->last_updated_by->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($report_history->last_updated_date->Visible) { // last_updated_date ?>
	<tr id="r_last_updated_date">
		<td class="col-sm-2"><span id="elh_report_history_last_updated_date"><?php echo $report_history->last_updated_date->FldCaption() ?></span></td>
		<td data-name="last_updated_date"<?php echo $report_history->last_updated_date->CellAttributes() ?>>
<span id="el_report_history_last_updated_date">
<span<?php echo $report_history->last_updated_date->ViewAttributes() ?>>
<?php echo $report_history->last_updated_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($report_history->last_updated_by->Visible) { // last_updated_by ?>
	<tr id="r_last_updated_by">
		<td class="col-sm-2"><span id="elh_report_history_last_updated_by"><?php echo $report_history->last_updated_by->FldCaption() ?></span></td>
		<td data-name="last_updated_by"<?php echo $report_history->last_updated_by->CellAttributes() ?>>
<span id="el_report_history_last_updated_by">
<span<?php echo $report_history->last_updated_by->ViewAttributes() ?>>
<?php echo $report_history->last_updated_by->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
