...
<?php if (!isset($userlevels_view->Pager)) $userlevels_view->Pager = new cPrevNextPager($userlevels_view->StartRec, $userlevels_view->DisplayRecs, $userlevels_view->TotalRecs, $userlevels_view->AutoHidePager) ?>
