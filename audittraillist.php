...
<option value="15"<?php if ($audittrail_list->DisplayRecs == 15) { ?> selected<?php } ?>>15</option>
...
<?php if ($audittrail->keyvalue->Visible) { // keyvalue ?>
	<?php if ($audittrail->SortUrl($audittrail->keyvalue) == "") { ?>
		<th data-name="keyvalue" class="<?php echo $audittrail->keyvalue->HeaderCellClass() ?>"><div id="elh_audittrail_keyvalue" class="audittrail_keyvalue"><div class="ewTableHeaderCaption"><?php echo $audittrail->keyvalue->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="keyvalue" class="<?php echo $audittrail->keyvalue->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->keyvalue) ?>',1);"><div id="elh_audittrail_keyvalue" class="audittrail_keyvalue">
...
<?php if ($audittrail->oldvalue->Visible) { // oldvalue ?>
	<?php if ($audittrail->SortUrl($audittrail->oldvalue) == "") { ?>
		<th data-name="oldvalue" class="<?php echo $audittrail->oldvalue->HeaderCellClass() ?>"><div id="elh_audittrail_oldvalue" class="audittrail_oldvalue"><div class="ewTableHeaderCaption"><?php echo $audittrail->oldvalue->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="oldvalue" class="<?php echo $audittrail->oldvalue->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->oldvalue) ?>',1);"><div id="elh_audittrail_oldvalue" class="audittrail_oldvalue">
...
<?php if ($audittrail->newvalue->Visible) { // newvalue ?>
	<?php if ($audittrail->SortUrl($audittrail->newvalue) == "") { ?>
		<th data-name="newvalue" class="<?php echo $audittrail->newvalue->HeaderCellClass() ?>"><div id="elh_audittrail_newvalue" class="audittrail_newvalue"><div class="ewTableHeaderCaption"><?php echo $audittrail->newvalue->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="newvalue" class="<?php echo $audittrail->newvalue->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->newvalue) ?>',1);"><div id="elh_audittrail_newvalue" class="audittrail_newvalue">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_keyvalue" class="audittrail_keyvalue">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_oldvalue" class="audittrail_oldvalue">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_newvalue" class="audittrail_newvalue">
