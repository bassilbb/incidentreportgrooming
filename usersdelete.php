...
fusersdelete.Lists["x_group"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_group_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"group"};
fusersdelete.Lists["x_group"].Data = "<?php echo $users_delete->group->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php if ($users->group->Visible) { // group ?>
		<th class="<?php echo $users->group->HeaderCellClass() ?>"><span id="elh_users_group" class="users_group"><?php echo $users->group->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($users->staff_id->Visible) { // staff_id ?>
		<th class="<?php echo $users->staff_id->HeaderCellClass() ?>"><span id="elh_users_staff_id" class="users_staff_id"><?php echo $users->staff_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($users->group->Visible) { // group ?>
		<td<?php echo $users->group->CellAttributes() ?>>
<span id="el<?php echo $users_delete->RowCnt ?>_users_group" class="users_group">
...
<?php } ?>
<?php if ($users->staff_id->Visible) { // staff_id ?>
		<td<?php echo $users->staff_id->CellAttributes() ?>>
<span id="el<?php echo $users_delete->RowCnt ?>_users_staff_id" class="users_staff_id">
