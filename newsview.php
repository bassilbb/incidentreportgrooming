...
<?php if (!isset($news_view->Pager)) $news_view->Pager = new cPrevNextPager($news_view->StartRec, $news_view->DisplayRecs, $news_view->TotalRecs, $news_view->AutoHidePager) ?>
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($news_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $news_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($news_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($news_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $news_view->PageUrl() ?>start=<?php echo $news_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<?php if ($news->code->Visible) { // code ?>
	<tr id="r_code">
		<td class="col-sm-2"><span id="elh_news_code"><?php echo $news->code->FldCaption() ?></span></td>
		<td data-name="code"<?php echo $news->code->CellAttributes() ?>>
<span id="el_news_code">
<span<?php echo $news->code->ViewAttributes() ?>>
<?php echo $news->code->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news->news->Visible) { // news ?>
	<tr id="r_news">
		<td class="col-sm-2"><span id="elh_news_news"><?php echo $news->news->FldCaption() ?></span></td>
		<td data-name="news"<?php echo $news->news->CellAttributes() ?>>
<span id="el_news_news">
<span<?php echo $news->news->ViewAttributes() ?>>
<?php echo $news->news->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news->news_image->Visible) { // news_image ?>
	<tr id="r_news_image">
		<td class="col-sm-2"><span id="elh_news_news_image"><?php echo $news->news_image->FldCaption() ?></span></td>
		<td data-name="news_image"<?php echo $news->news_image->CellAttributes() ?>>
<span id="el_news_news_image">
<span>
<?php echo ew_GetFileViewTag($news->news_image, $news->news_image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($news->news_content->Visible) { // news_content ?>
	<tr id="r_news_content">
		<td class="col-sm-2"><span id="elh_news_news_content"><?php echo $news->news_content->FldCaption() ?></span></td>
...
<?php echo $news->news_content->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
