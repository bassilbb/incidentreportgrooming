...
freport_formview.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_category"};
...
freport_formview.Lists["x_incident_location"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
...
freport_formview.Lists["x_operational_status"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"operational_status"};
freport_formview.Lists["x_operational_status"].Data = "<?php echo $report_form_view->operational_status->LookupFilterQuery(FALSE, "view") ?>";
...
freport_formview.Lists["x_closure_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freport_formview.Lists["x_closure_action"].Options = <?php echo json_encode($report_form_view->closure_action->Options()) ?>;
freport_formview.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
<?php if ($report_form->operational_status->Visible) { // operational_status ?>
	<tr id="r_operational_status">
		<td class="col-sm-2"><span id="elh_report_form_operational_status"><?php echo $report_form->operational_status->FldCaption() ?></span></td>
		<td data-name="operational_status"<?php echo $report_form->operational_status->CellAttributes() ?>>
<span id="el_report_form_operational_status" data-page="2">
<span<?php echo $report_form->operational_status->ViewAttributes() ?>>
<?php echo $report_form->operational_status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($report_form->closure_action->Visible) { // closure_action ?>
	<tr id="r_closure_action">
		<td class="col-sm-2"><span id="elh_report_form_closure_action"><?php echo $report_form->closure_action->FldCaption() ?></span></td>
		<td data-name="closure_action"<?php echo $report_form->closure_action->CellAttributes() ?>>
<span id="el_report_form_closure_action" data-page="2">
<span<?php echo $report_form->closure_action->ViewAttributes() ?>>
<?php echo $report_form->closure_action->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($report_form->closure_comment->Visible) { // closure_comment ?>
	<tr id="r_closure_comment">
		<td class="col-sm-2"><span id="elh_report_form_closure_comment"><?php echo $report_form->closure_comment->FldCaption() ?></span></td>
		<td data-name="closure_comment"<?php echo $report_form->closure_comment->CellAttributes() ?>>
<span id="el_report_form_closure_comment" data-page="2">
<span<?php echo $report_form->closure_comment->ViewAttributes() ?>>
<?php echo $report_form->closure_comment->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
